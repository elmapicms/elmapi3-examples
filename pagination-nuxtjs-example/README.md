# Pagination Nuxt.js Example

A Nuxt.js example demonstrating advanced pagination strategies with ElmapiCMS.
...
All pagination examples use Nuxt.js Server Components with the SDK:

1. The page component receives query parameters from the URL
